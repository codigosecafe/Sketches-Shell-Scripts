...
echo "|----------------------------------------------------------------------------------------------|"
env -i sudo apt-get install -y software-properties-common python-software-properties build-essential libssl-dev libmaxminddb-dev libncursesw5-dev libglib2.0-dev libgeoip-dev libtokyocabinet-dev
env -i sudo apt-get install -y curl unzip mcrypt git lynx vim aptitude
env -i sudo export TERM=xterm
echo "\n"
echo "|----------------------------------------------------|"
