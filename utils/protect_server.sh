...
#wget https://raw.githubusercontent.com/codigosecafe/meus-shell-scripts/desenvolvimento/jail.local
echo "# => Movendo o arquivo de configuração do fail2ban"
cp ~/script-up-server/jail.local /etc/fail2ban/jail.local
rm ~/script-up-server/jail.local
echo "\n"
